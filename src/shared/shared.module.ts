import {
    ADMIN_MAPPER, ADMIN_SETTINGS_MAPPER, AVAILABILITY_MAPPER, BOOKING_MAPPER, CART_MAPPER, CHAT_MAPPER, COUPON_MAPPER, CUSTOMER_MAPPER, MESSAGE_MAPPER,
    ...
    SERVICE_CATEGORY_MAPPER, SERVICE_OFFERED_MAPPER, SUBSCRIPTION_MAPPER, TRANSACTION_MAPPER, WALLET_LEDGER_MAPPER, WALLET_MAPPER
