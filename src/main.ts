...
import type { ICustomerRepository } from '@core/repositories/interfaces/customer-repo.interface';
import type { IProviderRepository } from '@core/repositories/interfaces/provider-repo.interface';
...
async function bootstrap() {
  ...
  const ALLOWED_URLS: string[] = (process.env.ALLOWED_URLS || '').split(',').map((url) => url.trim());
