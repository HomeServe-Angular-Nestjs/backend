...
export class CategoryController {
  ...
  async updateProfession(
    @Body() updateProfessionDto: CreateProfessionDto,
    @Param('id', new isValidIdPipe()) professionId: string,
  ): Promise<IResponse<IProfession>> {
  ...
  async updateServiceCategory(
    ...
    @Param('id', new isValidIdPipe()) serviceCategoryId: string,
  ...
  async fetchAvailableServiceByProfessionId(
    @Param('id', new isValidIdPipe()) professionId: string,
  ): Promise<IResponse<IServiceCategory[]>> {
