...
export const repositoryProviders: Provider[] = [
  ...
  },
  {
    ...
    useFactory: (dateOverridesModel: Model<DateOverrideDocument>) => new DateOverridesRepository(dateOverridesModel),
  ...
  },
  {
    ...
    useFactory: (serviceOfferedModel: Model<ServiceDocument>) => new ServiceOfferedRepository(serviceOfferedModel),
  ...
  },
  {
    ...
    useFactory: (reportModel: Model<ReportDocument>) => new ReportRepository(reportModel),
    inject: [getModelToken(REPORT_MODEL_NAME)],
  },
  {
    provide: RESERVATION_REPOSITORY_NAME,
    useFactory: (reservationModel: Model<ReservationDocument>) => new ReservationRepository(reservationModel),
