...
export interface ISlotRuleService {
    createRule(providerId: string, createRuleDto: CreateRuleDto): Promise<IResponse<ISlotRule>>;
    editRule(providerId: string, ruleId: string, editRuleDto: EditRuleDto): Promise<IResponse<ISlotRule>>;
