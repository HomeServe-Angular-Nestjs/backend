...
import {
  ...
  ADMIN_REVIEWS_SERVICE_NAME, ADMIN_SALES_REPORT_SERVICE_NAME, ADMIN_SETTINGS_SERVICE_NAME, ADMIN_TRANSACTION_SERVICE_NAME, ADMIN_USER_MANAGEMENT_SERVICE_NAME, TOKEN_SERVICE_NAME
