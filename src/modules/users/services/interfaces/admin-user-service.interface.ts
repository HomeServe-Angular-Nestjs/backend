import type { IUserDataWithPagination } from '@core/entities/interfaces/admin.entity.interface';
import type { GetUsersWithFilterDto, RemoveUserDto, StatusUpdateDto, UserReportDownloadDto } from '@modules/users/dtos/admin-user.dto';
