import { PLAN_MODEL_NAME, PROFESSION_MODEL_NAME, PROVIDER_SERVICE_MODEL_NAME, SERVICE_CATEGORY_MODEL_NAME, SUBSCRIPTION_MODEL_NAME, ADMIN_SETTINGS_MODEL_NAME } from "@core/constants/model.constant";
