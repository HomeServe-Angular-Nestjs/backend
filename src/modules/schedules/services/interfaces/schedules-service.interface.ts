...
import { IScheduleDay, IScheduleList, IScheduleListWithPagination } from "src/core/entities/interfaces/schedules.entity.interface";

export interface ISchedulesService {
    createSchedules(providerId: string, dto: MonthScheduleDto): Promise<IResponse>;
    fetchSchedules(providerId: string, dto: ScheduleListFilterDto): Promise<IResponse<IScheduleListWithPagination>>;
