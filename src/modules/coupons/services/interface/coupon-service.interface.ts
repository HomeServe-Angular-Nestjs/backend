import type { ICoupon, ICouponAppliedResponse, ICouponWithPagination } from '@core/entities/interfaces/coupon.entity.interface';
import type { IResponse } from '@core/misc/response.util';
import type { ApplyCouponPayloadDto, CouponFilterDto, UpsertCouponDto } from '@modules/coupons/dtos/coupon.dto';
...
export interface ICouponService {
  ...
  applyCoupon(applyCouponPayload: ApplyCouponPayloadDto): Promise<IResponse<ICouponAppliedResponse>>;
}
