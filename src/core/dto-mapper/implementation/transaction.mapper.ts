  ...
  toDocument(entity: Partial<ITransaction>): Partial<TransactionDocument> {
    return {
      ...
      metadata: entity?.metadata
        ? {
            bookingId: entity.metadata?.bookingId ? new Types.ObjectId(entity.metadata.bookingId) : null,
            subscriptionId: entity.metadata?.subscriptionId ? new Types.ObjectId(entity.metadata.subscriptionId) : null,
            breakup: {
              ...
              coupon: entity.metadata?.breakup?.coupon
                ? {
                    couponId: entity.metadata.breakup.coupon.couponId ? new Types.ObjectId(entity.metadata.breakup.coupon.couponId) : null,
