...
export class WalletLedgerMapper implements IWalletLedgerMapper {
  toEntity(doc: WalletLedgerDocument): IWalletLedger {
    return new WalletLedger({
      ...
      bookingTransactionId: doc.bookingTransactionId ? doc.bookingTransactionId.toString() : null,
      subscriptionTransactionId: doc.subscriptionTransactionId ? doc.subscriptionTransactionId.toString() : null,
