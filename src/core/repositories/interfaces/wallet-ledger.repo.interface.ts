...
export interface IWalletLedgerRepository extends IBaseRepository<WalletLedgerDocument> {
  ...
  getFilteredCustomerLedgersByUserIdWithPagination(
    userId: string,
    filters: IWalletTransactionFilter,
    options: { page: number; limit: number },
  ): Promise<ICustomerTransactionData[]>;
  getFilteredProviderLedgersByUserIdWithPagination(
    userId: string,
    filters: IWalletTransactionFilter,
    options: { page: number; limit: number },
  ...
  getAdminTransactionLists(filters: IWalletTransactionFilter, options: { page: number; limit: number }): Promise<IAdminLedgerRecord[]>;
